...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY 𝙼𝙰𝚁𝙲𝙾 𝙼𝙰𝙻𝙸𝙺*",
...
MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://i.ibb.co/K8cFyfj/file-00000000b7607208b3cf2ed83cb20148.png",
// add custom menu and mention reply image url
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "𝙼𝙰𝚁𝙲𝙾 𝙼𝙰𝙻𝙸𝙺",
// add bot namw here for menu
AUTO_STATUS_REACT: process.env.AUTO_STATUS_REACT || "false",
// true to get auto status react
STICKER_NAME: process.env.STICKER_NAME || "𝙼𝙰𝚁𝙲𝙾 𝙼𝙰𝙻𝙸𝙺",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "923706328012",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "𝙼𝙰𝚁𝙲𝙾 𝙼𝙰𝙻𝙸𝙺",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*©ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝙼𝙰𝚁𝙲𝙾 𝙼𝙰𝙻𝙸𝙺*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://i.ibb.co/K8cFyfj/file-00000000b7607208b3cf2ed83cb20148.png",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> I'ᗩᗰ *𝙼𝙰𝚁𝙲𝙾 𝙼𝙰𝙻𝙸𝙺*❤️‍🔥",
// add alive msg here 
...
DEV: process.env.DEV || "923706328012",
